...
| --- | --- | --- |
| UI | F2.1, F3.1, F3.2, F3.3, F3.4, NF3.1, NF3.2 | CTR-4, CTR-5, CTR-6, TC, TC, TC, TC |
| Winkellogik | F1.3, F2.2, F4.1, F4.2, F5.1, F5.2, NF2.1, NF4.1 | CTR-3, TC, CTR-7, CTR-8, TC, TC, TC, TC |
| HardwareAbstraction | F1.1, F1.2, NF1.1, NF1.2 | CTR-1, CTR-2, TC, TC |
